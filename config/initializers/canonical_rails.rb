...
CanonicalRails.setup do |config|
  ...
  config.host = 'www.TakeHotter.com'

  # http://en.wikipedia.org/wiki/URL_normalization
  # Trailing slash represents semantics of a directory, ie a collection view - implying an :show get route;
  ...
  # Parameter spamming can cause show dilution by creating seemingly different URLs with identical or near-identical content.
