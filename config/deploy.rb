...
task :staging do
  set :domain, 'staging.TakeHotter.com'
  set :repository, 'git@bitbucket.org:naveedahmad/TakeHotter.git'
...
task :production do
  set :domain, 'TakeHotter.com'
  set :repository, 'git@bitbucket.org:kylesziv/TakeHotter.git'
  set :branch, 'redesign'
end

set :deploy_to, '/home/deployer/TakeHotter'
set :user, 'deployer'
set :port, '22'
set :term_mode, nil
